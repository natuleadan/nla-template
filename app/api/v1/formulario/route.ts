...
export async function POST(request: Request) {
  try {
    ...
    if (!data || typeof data !== "object") return badRequest("Cuerpo JSON requerido")
    ...
    return NextResponse.json({ success: true, message: "Mensaje enviado correctamente", data: formData })
  } catch (error) {
