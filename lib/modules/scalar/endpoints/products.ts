  ...
  return {
          ...
          content: {
            "application/json": {
              schema: {
                ...
                properties: { name: { type: "string" }, price: { type: "number" }, category: { type: "string" }, description: { type: "string" }, images: { type: "array", items: { type: "string" } } },
              },
              example: { name: "Nuevo Producto", price: 19990, category: "suplements", description: "Descripción del producto", images: ["/images/product.jpg"] },
            },
          },
        },
        responses: {
    ...
    "/api/v1/products/{slug}": {
      ...
      post: {
        ...
        security: [{ ApiKeyAuth: [] }],
        parameters: [
          { name: "slug", in: "path", required: true, schema: { type: "string" }, description: "Slug del producto" },
        ],
        requestBody: {
          required: true,
          content: {
            "application/json": {
              ...
              example: { name: "Nuevo Producto", price: 19990, category: "suplements" },
            },
          },
        },
        responses: {
