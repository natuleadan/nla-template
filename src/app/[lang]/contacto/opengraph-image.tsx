...
export default async function ContactOpenGraphImage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", zIndex: 1, padding: "0 48px", marginTop: 80 }}>
          ...
          <div style={{ fontSize: 28, color: "#ffffff", textShadow: "1px 1px 4px rgba(0,0,0,0.7)", textAlign: "center", maxWidth: 800, lineHeight: 1.4 }}>
