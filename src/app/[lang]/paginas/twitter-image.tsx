    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", zIndex: 1, padding: "0 48px", marginTop: 70 }}>
          <div style={{ fontSize: 56, fontWeight: 700, color: "#ffffff", textShadow: "2px 2px 8px rgba(0,0,0,0.7)", marginBottom: 16 }}>
            {cfg.paginas.page.title}
          </div>
          <div style={{ fontSize: 24, color: "#ffffff", textShadow: "1px 1px 4px rgba(0,0,0,0.7)", textAlign: "center", maxWidth: 700, lineHeight: 1.4 }}>
            {cfg.paginas.page.description}
          </div>
        </div>
      </div>
    ),
